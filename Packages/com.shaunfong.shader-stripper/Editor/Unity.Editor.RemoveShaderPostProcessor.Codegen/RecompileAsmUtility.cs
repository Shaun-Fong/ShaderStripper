...
namespace com.shaunfong.ShaderStripper.Editor
{
    public class RecompileAsmUtility
    {
        ...
        public static readonly string TempCompileTargetFile = "Temp/com.shaunfong.shader-stripper.asmtarget.txt";
        ...
        public static void Check()
        {
            ...
            string path = "Temp/com.shaunfong.shader-stripper.tmp.txt";
